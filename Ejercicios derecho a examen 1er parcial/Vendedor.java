...
public class Vendedor{
	...
	System.out.println("Si el vendedor vendió igual o menos de 10,000,000 	ponga 1");
 	System.out.println("Si el vendedor vendió mas de 10 y menos de 15 	millones ponga 2");
	System.out.println("Si el vendedor vendió mas de 15 millones ponga 3 	");
		System.out.println("Cuanto vendió en el mes para darle su información");
	opcion = sc.nextInt();
		switch (opcion) {
	case 1:
